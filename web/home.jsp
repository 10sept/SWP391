                    ...
                    <div class="col-md-4 col-xs-6">
                        <div class="shop">
                            ...
                            <div class="shop-body">
                                ...
                                <a href="allproduct" class="cta-btn">Mua Ngay <i class="fa fa-arrow-circle-right"></i></a>
                            </div>
                        </div>
                    </div>
                    <!-- /shop -->
                            ...
                            <div class="section-nav">
                                <ul class="section-tab-nav tab-nav">
                                    <c:forEach items="${requestScope.listCategory}" var="lc">
                                        <li class="${requestScope.selectedCategoryId == lc.id ? 'active' : ''}">
                                            <a href="#" onclick="submitForm(${lc.id})">${lc.name}</a>
                                        </li>
                                    </c:forEach>
                                </ul>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <div class="section-title">
                            ...
                            <div class="section-nav">
                                <form action="/home" method="post" id="categoryForm">
                                    <ul class="section-tab-nav tab-nav">
